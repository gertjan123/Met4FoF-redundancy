...
class MetrologicalMultiWaveGeneratorAgent(MetrologicalAgent):
    ...
    _data_stream: MetrologicalMultiWaveGenerator
    batch_size = 100

    def init_parameters(self, signal: MetrologicalMultiWaveGenerator = MetrologicalMultiWaveGenerator(), **kwargs):
...
class RedundancyAgent(MetrologicalAgent):
    ...
    def init_parameters2(self, fsam, f1, f2, ampl_ratio, phi1, phi2):
        ...
        # print('f1=',f1)
        # print('f2=', f2)
        # integer check is_integer(f1/df) ?

        ind_freq1 = f1/df
        ind_freq2 = f2/df
        # print('ind_freq1=', ind_freq1)
        # print('ind_freq2=', ind_freq2)
        ind_freq1 = int(ind_freq1)
        ind_freq2 = int(ind_freq2)
        # print('ind_freq1=', ind_freq1)
        # print('ind_freq2=', ind_freq2)
    ...
    def agent_loop(self):
        ...
        if self.current_state == "Running":
            ...
            if self.calc_type == "lcs":
                ...
                # print('shape a_arr: ', self.a_arr.shape)
                # print('shape a_arr2d: ', self.a_arr2d.shape)
                # print('shape x_data_arr: ', x_data_arr.shape)
                # print('shape vx_arr2d: ', vx_arr2d.shape)
