...
#. :mod:`calc_lcs`: Calculation of the largest subset of consistent estimates of a measurand.
#. :mod:`calc_lcss`: Calculation of the largest subset of sensor values that yield consistent estimates of a measurand
